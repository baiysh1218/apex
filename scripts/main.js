...
(function() {
    ...
    async function submitForm(e) {
        ...
        try {
            ...
            if (GOOGLE_SCRIPT_URL === 'YOUR_GOOGLE_APPS_SCRIPT_URL_HERE') {
                ...
                showFormMessage(form, 'Спасибо! Мы скоро свяжемся с вами.', true);
                form.reset();
            } else {
            ...
            showFormMessage(form, 'Произошла ошибка. Попробуйте позже или позвоните нам.', false);
        } finally {
    ...
    function initScrollAnimations() {
        const animatedElements = document.querySelectorAll('.learn-card, .benefit-card, .author-facts li');
